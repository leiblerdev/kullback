...
from harness.builder.policy import (
    HELPERS_SRC,
    accept_rewrite,
    compile_policy,
    compile_rule,
...
from harness.shared.records import Constraint, ConstraintTests, Event, Run
...
def test_compile_policy_over_three_sentences(policy_md):
