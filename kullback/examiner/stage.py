...
# batches and D198's reason per check with no input, and the reference record carries D193's second
# pass over a residue and what deriving a Verifier per survivor settled (D198)
