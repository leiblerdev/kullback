...
def _ask_user(state: RunState) -> Optional[str]:
    """Ask the Simulated user for its turn and record it, counting only the events it added here."""
