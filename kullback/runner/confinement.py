...
outside its own case, shared by verdict.py's atoms and gates/confinement.py's constraints."""
...
DENIED_NAMES = frozenset({
    ...
    # The builtins mapping itself: naming it reaches every allowed builtin as data to be edited.
    "__builtins__",
})
