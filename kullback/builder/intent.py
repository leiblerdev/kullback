...
from kullback.user.value_strip import RESERVED_VALUES as RESERVED_VALUES
from kullback.user.value_strip import STRIP_PUNCTUATION as STRIP_PUNCTUATION
from kullback.user.value_strip import TRAILING_WORDS as TRAILING_WORDS
from kullback.user.value_strip import _flat as _flat
from kullback.user.value_strip import _is_code as _is_code
from kullback.user.value_strip import _month_of as _month_of
from kullback.user.value_strip import _protected_spans as _protected_spans
from kullback.user.value_strip import _said as _said
from kullback.user.value_strip import _strip_known as _strip_known
from kullback.user.value_strip import _tidy as _tidy
from kullback.user.value_strip import _token_at as _token_at
from kullback.user.value_strip import _value_text as _value_text
from kullback.user.value_strip import _walk_values as _walk_values
from kullback.user.value_strip import canon_rules_of as canon_rules_of
from kullback.user.value_strip import replacement_for as replacement_for
from kullback.user.value_strip import spoken_text as spoken_text
from kullback.user.value_strip import strip_intent as strip_intent
from kullback.user.value_strip import system_values as system_values
