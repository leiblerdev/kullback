...
| CRMArena-Pro | CRM, 19 tasks | live Salesforce org, 25 objects | yes | exact match, F1, LLM judge; not a state diff | no | Salesforce sandbox | cc-by-nc-4.0, not CC BY-SA 4.0 (corrected 2026-09-24, checked live on the Hub card) | env only, heavy |
