...
- Not published: the export's leak scan refused 13 Verifiers whose atoms quote a whole recorded agent message. The
  Hub still carries smoke 8, published under the tag build-20260923.
