...
- **2026-09-24.** Retail and airline now replay every Task, and both are released on Hugging Face as `build-20260924` (airline moved from preview to release).
...
|---|---|---|
| Tasks | 223 | 130 |
| Tasks replayed faithfully | 100% | 100% |
