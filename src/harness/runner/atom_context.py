...
from harness.shared.canon import canon_value, compare
from harness.shared.confinement import SAFE_BUILTINS, confine
...
def gate(source: str) -> list[str]:
    ...
    shared/confinement.py holds the actual check, so validate.py's constraint gate cannot drift
    from this one.
    """
