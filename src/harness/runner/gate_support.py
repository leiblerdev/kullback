"""The small helpers every gate in validate.py and scorecard.py is built from: one GateResult
shape, field access that works on a record or its JSON dict, and equality after canonicalization
(D39, D80)."""
...
from harness.shared.records import GateResult, content_hash
